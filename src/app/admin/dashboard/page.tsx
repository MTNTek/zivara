import { getDashboardStats, getRecentOrders, type RecentOrder } from '@/features/admin/queries';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Welcome to the Zivara admin panel</p>
        </div>
