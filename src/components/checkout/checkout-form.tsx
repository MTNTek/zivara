      ...
      <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 min-h-[44px] border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F52BA] text-base ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" id="city" name="city" required value={formData.city} onChange={handleChange}
                className={`w-full px-4 py-3 min-h-[44px] border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F52BA] text-base ${getFieldError('city') ? 'border-red-500' : 'border-gray-300'}`}
              />
            ...
            <div>
              ...
              <input type="text" id="state" name="state" required value={formData.state} onChange={handleChange}
                className={`w-full px-4 py-3 min-h-[44px] border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F52BA] text-base ${getFieldError('state') ? 'border-red-500' : 'border-gray-300'}`}
              />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" id="postalCode" name="postalCode" required value={formData.postalCode} onChange={handleChange}
                className={`w-full px-4 py-3 min-h-[44px] border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F52BA] text-base ${getFieldError('postalCode') ? 'border-red-500' : 'border-gray-300'}`}
              />
            ...
            <div>
              ...
              <input type="text" id="country" name="country" required value={formData.country} onChange={handleChange}
                className={`w-full px-4 py-3 min-h-[44px] border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F52BA] text-base ${getFieldError('country') ? 'border-red-500' : 'border-gray-300'}`}
              />
