...
const categories: Category[] = [
  ...
  { name: 'Pet Supplies', href: '/products?category=pets' },
  { name: 'Office Products', href: '/products?category=office' },
  { name: 'Garden & Outdoor', href: '/products?category=garden' },
  { name: 'Food & Grocery', href: '/products?category=food' },
];
