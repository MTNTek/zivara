...
export default function Navbar() {
  ...
  return (
    <div className="bg-[#032854] text-white">
      <div className="w-full flex items-center gap-2 px-4 py-2">
        {/* Logo - Left Side */}
        <Link href="/" className="text-2xl font-bold cursor-pointer transition-colors whitespace-nowrap flex-shrink-0">
          Zivara
        </Link>
                ...
                <div className="flex h-[600px]">
                  ...
                  <div className="w-1/2 p-6 overflow-y-auto border-r border-gray-200">
                    ...
                    <div className="mb-6">
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#032854] text-gray-900"
                        />
                    ...
                    <button 
                      ...
                      className="w-full flex items-center gap-3 p-4 mb-4 border border-[#032854] rounded-lg hover:bg-gray-50 transition-colors"
                    >
                      <svg className="w-5 h-5 text-[#032854]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <form onSubmit={handleSearch} className="flex-1 flex relative">
          ...
          <input
            ...
            className="flex-1 min-w-0 px-3 py-1.5 text-sm text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-orange-400"
                  ...
                  {trendingSearches.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="text-sm font-medium text-gray-900 group-hover:text-[#032854]">
                          {item.text}
                        </div>
                        <div className="text-xs text-gray-500">{item.category}</div>
                      </div>
                      <svg className="w-4 h-4 text-gray-400 group-hover:text-[#032854]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button 
            type="submit"
            className="bg-orange-400 hover:bg-orange-500 px-4 rounded-r-md transition-colors text-[#032854] flex-shrink-0"
          >
