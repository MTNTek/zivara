...
const navigation = [
  ...
  },
  {
    name: 'Orders',
    href: '/admin/orders',
    badgeKey: 'pendingOrders' as string | null,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    name: 'Messages',
    href: '/admin/messages',
    badgeKey: 'newMessages' as string | null,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function AdminSidebar() {
  ...
  const [badges, setBadges] = useState<BadgeCounts>({ pendingOrders: 0, newMessages: 0 });
        ...
        <div className="flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-white">
          ...
          <div className="flex h-16 flex-shrink-0 items-center border-b border-gray-200 px-6">
            <Link href="/admin/dashboard" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900">Zivara</span>
            ...
            {navigation.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {badgeCount > 0 && (
                    <span className="ml-2 bg-orange-100 text-orange-700 text-xs font-semibold px-2 py-0.5 rounded-full min-w-[20px] text-center">
